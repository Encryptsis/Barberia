...
class UsuariosServiciosSeeder extends Seeder
{
    public function run()
    {
        DB::table('usuarios_servicios')->insert([
            ...
            [
                'usr_srv_usuario_id' => 13, // juanita.caballero
            ...
            [
                'usr_srv_usuario_id' => 14, // pedro.lopez
            ...
            [
                'usr_srv_usuario_id' => 15, // sofia.ramirez
            ...
            [
                'usr_srv_usuario_id' => 16, // alejandro.molina
                'usr_srv_servicio_id' => 5, // Beer Grooming
            ...
            [
                'usr_srv_usuario_id' => 17, // ana.rodriguez
                'usr_srv_servicio_id' => 3, // Facial
            ...
            [
                'usr_srv_usuario_id' => 18, // luis.gonzalez
                'usr_srv_servicio_id' => 3, // Facial
            ...
            [
                'usr_srv_usuario_id' => 19, // laura.blanco
            ...
            [
                'usr_srv_usuario_id' => 20, // javier.sanchez
                'usr_srv_servicio_id' => 1, // Hydrogen Oxigen
